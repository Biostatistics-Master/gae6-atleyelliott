...
```{r}
#| label: tbl-planned
#| tbl-cap: "Planned hypothesis test"
...
The p-values for the Control-uninfected comparison and the Control-Infected values are the only ones that have significantly different means.
